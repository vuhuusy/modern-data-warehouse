...
#
# IMPORTANT: Production environment has stricter security controls:
# - Access logging enabled by default
# - Longer retention periods for compliance
# - All buckets have deletion protection considerations
#
################################################################################
...
module "raw_bucket" {
  ...
  # Use KMS encryption for production data
...
################################################################################
# Access Logs (Required for Production)
################################################################################
#
